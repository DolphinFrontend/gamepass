...
import "swiper/css"
import {GreenBtn, YellowTag} from "../../components/Common.styles"

import { imgBreakPoint } from "../../globalVars";

import {HeroBgImg,HeroSection,HeroContent,HeroContentTitle,HeroContentSubtitle} from "./Hero.styles"
...
const slideShowData = [
    {
        ...
        subtitle : "Streaming live on Sunday , May 31 , 2022",
        images : {
            small : xbox,
            big : xbox_big,
        },
