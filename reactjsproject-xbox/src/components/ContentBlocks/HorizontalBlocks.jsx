...
import { YellowTag,GreenBtn } from "../Common.styles";
...
import start_wars_big from "../../media/other_section/star_wars_big.jpg"
...
const StarWarsBlock = () => {
         return(
			 <HorizontalBlock>
				 <BlockImg>
					 <source media={imgBreakPoint} srcSet={start_wars_big} />
                 ...
                 <StarWarsDescription>
					 <BlockTitle>SIMPLY NEXT GEN</BlockTitle>
                      ...
                      <BlockSubtitle>Experience next gen with LEGO® Star Wars™: the Skywalker Saga with Xbox
					Series S
					</BlockSubtitle>
